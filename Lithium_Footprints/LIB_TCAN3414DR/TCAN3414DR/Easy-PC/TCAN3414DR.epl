...
(library Library_1
	...
	(compDef "TCAN3414DR" (originalName "TCAN3414DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "SHDN,VIO") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/tcan3414.pdf?ts=1713723144569&ref_url=https%253A%252F%252Fwww.mouser.ch%252F")
		(attr "Height" "1.75 mm")
	)
