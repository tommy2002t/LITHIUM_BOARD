...
//19292696/1858054/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TCAN3414DR" (originalName "TCAN3414DR")
	...
	(compDef "TCAN3414DR" (originalName "TCAN3414DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "SHDN,VIO") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCAN3414DR"))
		...
		(attr "Mouser Part Number" "595-TCAN3414DR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TCAN3414DR?qs=mELouGlnn3egF2AojRJddw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TCAN3414DR")
		(attr "Description" "3.3-V CAN FD transceiver with shut-down and standby mode")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tcan3414.pdf?ts=1713723144569&ref_url=https%253A%252F%252Fwww.mouser.ch%252F")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TCAN3414DR.stp")
