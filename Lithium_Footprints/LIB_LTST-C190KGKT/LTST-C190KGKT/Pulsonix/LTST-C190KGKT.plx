...
(library Library_1
	...
	(symbolDef "LTST-C190KGKT" (originalName "LTST-C190KGKT")
	...
	(compDef "LTST-C190KGKT" (originalName "LTST-C190KGKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C190KGKT"))
		...
		(attr "Mouser Part Number" "859-LTST-C190KGKT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Lite-On/LTST-C190KGKT?qs=205qCy6M2Q%252BAdcgwUZktqw%3D%3D")
		(attr "Manufacturer_Name" "Lite-On")
		(attr "Manufacturer_Part_Number" "LTST-C190KGKT")
		(attr "Description" "Lite-On LTST-C190KGKT, 571 nm Green LED, 1608 (0603) SMD package")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "LTST-C190KGKT.stp")
