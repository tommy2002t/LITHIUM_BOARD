...
(library Library_1
	...
	(symbolDef "LTST-C190KRKT" (originalName "LTST-C190KRKT")
	...
	(compDef "LTST-C190KRKT" (originalName "LTST-C190KRKT") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTST-C190KRKT"))
		...
		(attr "Mouser Part Number" "859-LTST-C190KRKT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/LITEON/LTST-C190KRKT?qs=kAD5fFa1n5VY3YYNWPC1Fg%3D%3D")
		(attr "Manufacturer_Name" "Lite-On")
		(attr "Manufacturer_Part_Number" "LTST-C190KRKT")
		(attr "Description" "LED,SMD,0603,Red,54mcd,130deg Lite-On LTST-C190KRKT Red LED, 631 nm, 1608 (0603), Rectangle Lens SMD Package")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/LTST-C190KRKT.pdf")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "LTST-C190KRKT.stp")
		(attr "<STEP Offsets>" "X=-0.03;Y=0;Z=0.28")
