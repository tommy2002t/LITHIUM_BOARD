...
//1759478/1858054/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "RC0603FR-07249KL" (originalName "RC0603FR-07249KL")
	...
	(compDef "RC0603FR-07249KL" (originalName "RC0603FR-07249KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0603FR-07249KL"))
		...
		(attr "Mouser Part Number" "603-RC0603FR-07249KL")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=603-RC0603FR-07249KL")
		(attr "Manufacturer_Name" "Yageo Group")
		(attr "Manufacturer_Part_Number" "RC0603FR-07249KL")
		(attr "Description" "Thick Film Resistors - SMD 249K OHM 1%")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/RC0603FR-07249KL.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "RC0603FR-07249KL.stp")
